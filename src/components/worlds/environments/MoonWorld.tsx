...
export default function MoonWorld({ world }: Props) {
  return (
    <group name="moon-world">
      ...
      <gridHelper args={[200, 50, world.terrain?.padColor, '#222222']} position={[0, -1.99, 0]} />
      ...
      <ContactShadows position={[0, -1.99, 0]} opacity={0.8} scale={20} blur={0.5} far={4} color="#000000" />
